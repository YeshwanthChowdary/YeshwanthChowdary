# 💫 About Me
Backend Developer specializing in **Golang** with a focus on **high-performance API development** and **microservices architecture**.
I build scalable backend systems, write clean and maintainable code, and enjoy solving complex distributed-systems challenges.
...
![gRPC](https://img.shields.io/badge/gRPC-%23F05033.svg?style=for-the-badge&logo=grpc&logoColor=white)
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-%23326ce5.svg?style=for-the-badge&logo=gitlab&logoColor=white)
...
## 🚀 What I Do
- Design and develop **REST and gRPC APIs** using Go and Gin.
- Build **microservices** with clean architecture principles.
- Integrate **PostgreSQL, Redis**, and other data stores for optimal performance.
- Deploy containerized apps with **Docker** and **CI/CD pipelines**.
- Focus on **writing efficient, testable, and maintainable Go code**.
